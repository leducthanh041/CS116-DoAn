...
def load_and_split_data(raw_data_path, hist_end_date, hist_days, recent_days):
    ...
    df_user = read_parquet_folder(raw_data_path, 'user_chunk')
    df_item = read_parquet_folder(raw_data_path, 'item_chunk')
    df_trx = read_parquet_folder(raw_data_path, 'purchase_history_daily_chunk')
